...
const (
	baseURL    = "http://www.conceptclub.ru"
	outputDir  = "images"
	outputJSON = "conceptclub.json"
)
...
func getCategories() map[string]string {
	...
	doc, _ := goquery.NewDocument(baseURL + "/vsya-odezhda")
	doc.Find("#sidebar > ul > li:nth-child(1) > ul > li").Each(func(i int, s *goquery.Selection) {
