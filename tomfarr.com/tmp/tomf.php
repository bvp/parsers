<?php
	...
	for ($page=0; $page<24; $page++) { //всего 33 страницы в мужском (до 24 страницы Tom Farr)

		if(($page!=0)&&($page!=1)) {
			$pageur = '-'.$page;
			$pageur = 'http://www.tomfarr.com/collection/view/muzhskaya-odezhda'.$pageur.'.html';
		} 
		if($page==1){
			$pageur = 'http://www.tomfarr.com/collection/view/muzhskaya-odezhda.html';
		}
		$url = $pageur;
