/* Catalog parser for http://www.td-fabrik.ru */
package main
...
func getCategories() map[string]string { // {{{
	...
	getPageDoc(baseURL + "/catalog/").Find("body > div.all > div.center > div.page.cle > div.p_side > ul.p_side_menu > li").Each(func(i int, s *goquery.Selection) {
